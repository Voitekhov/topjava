...
abstract class AbstractJdbcMealRepository implements MealRepository {
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, ConvertDate(startDateTime),
                ConvertDate(endDateTime));
    }

    protected abstract Timestamp ConvertDate(LocalDateTime dateTime);
